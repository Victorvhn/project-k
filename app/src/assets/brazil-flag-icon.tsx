export interface BrazilFlagIconProps
  extends React.HTMLAttributes<HTMLOrSVGElement> {}

export const BrazilFlagIcon = (props: BrazilFlagIconProps) => (
  <svg
  ...
  >
    <defs>
      ...
      />
      <use id='q' transform='scale(15)' />
      <use id='s' transform='scale(10.5)' />
      <use id='r' transform='scale(21)' />
      <use id='o' transform='scale(31.5)' />
      <use id='p' transform='scale(26.25)' />
      <g id='a' fill='#fff'>
        <g id='c'>
    ...
    <g transform='translate(-420 1470)' fill='#009b3a'>
      <use y='-1697.5' transform='rotate(-7)' />
      <use y='-1697.5' transform='rotate(-4)' />
      <use y='-1697.5' transform='rotate(-1)' />
      <use y='-1697.5' transform='rotate(2)' />
      <use y='-1697.5' transform='rotate(5)' />
      <use y='-1697.5' transform='rotate(9.75)' />
      <use y='-1697.5' transform='rotate(14.5)' />
      <use y='-1697.5' transform='rotate(17.5)' />
      <use y='-1697.5' transform='rotate(20.5)' />
      <use y='-1697.5' transform='rotate(23.5)' />
      <use y='-1697.5' transform='rotate(26.5)' />
      <use y='-1697.5' transform='rotate(29.5)' />
      <use y='-1697.5' transform='rotate(32.5)' />
      <use y='-1697.5' transform='rotate(35.5)' />
      <use y='-1697.5' transform='rotate(38.5)' />
    </g>
    <use y='-132' x='-600' />
    <use y='177' x='-535' />
    <use y='243' x='-625' />
