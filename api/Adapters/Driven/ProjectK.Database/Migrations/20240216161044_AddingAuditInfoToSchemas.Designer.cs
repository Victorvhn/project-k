...
namespace ProjectK.Database.Migrations
{
    ...
    [Migration("20240216161044_AddingAuditInfoToSchemas")]
    partial class AddingAuditInfoToSchemas
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ProjectK.Core.Entities.Category", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAtUtc")
                        ...
                        .HasDefaultValue(new DateTime(2024, 2, 16, 16, 10, 44, 396, DateTimeKind.Utc).AddTicks(5160))
            ...
            modelBuilder.Entity("ProjectK.Core.Entities.CustomPlannedTransaction", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAtUtc")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 2, 16, 16, 10, 44, 399, DateTimeKind.Utc).AddTicks(8310))
                        .HasColumnName("created_at_utc");
            ...
            modelBuilder.Entity("ProjectK.Core.Entities.PlannedTransaction", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAtUtc")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 2, 16, 16, 10, 44, 398, DateTimeKind.Utc).AddTicks(6600))
                        .HasColumnName("created_at_utc");
            ...
            modelBuilder.Entity("ProjectK.Core.Entities.Transaction", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAtUtc")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 2, 16, 16, 10, 44, 402, DateTimeKind.Utc).AddTicks(1830))
                        .HasColumnName("created_at_utc");
